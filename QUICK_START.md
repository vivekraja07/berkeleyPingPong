...
2. Go to **SQL Editor**
3. Click **New Query**
4. Open the file `round_robin_schema.sql` in this project
...
Run the example queries to see how to get data for charts:
...
### Import from URL
```bash
python3 import_round_robin.py --url <url>
```

### Import from local file
```bash
python3 import_round_robin.py --file path/to/file.html
```

### Query player statistics
```bash
python3 import_round_robin.py --query-player "Player Name"
```

### List all players
```bash
python3 import_round_robin.py --list-players
```
